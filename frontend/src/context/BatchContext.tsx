...
// The legacy `useBatch()` / `currentBatch` / `availableBatches`
// exports remain as aliases so the existing call sites keep
// working — the rename is additive, not a hard cut. New code
// should prefer the `useProgram()` API.
//
